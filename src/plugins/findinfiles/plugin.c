/* plugin.c generated by valac 0.32.0.61-f103e, the Vala compiler
...
enum  {
	GEDIT_FIND_IN_FILES_PLUGIN_WINDOW_DUMMY_PROPERTY,
	GEDIT_FIND_IN_FILES_PLUGIN_WINDOW_WINDOW
};
...
static void __lambda6_ (Block1Data* _data1_, gint response_id);
...
static void _gedit_find_in_files_plugin_window_dialog_run_g_simple_action_activate (GSimpleAction* _sender, GVariant* parameter, gpointer self);
...
static void _vala_gedit_find_in_files_plugin_window_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec);
static void _vala_gedit_find_in_files_plugin_window_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec);
...
enum  {
	GEDIT_FIND_IN_FILES_PLUGIN_APP_DUMMY_PROPERTY,
	GEDIT_FIND_IN_FILES_PLUGIN_APP_APP
};
...
static void _vala_gedit_find_in_files_plugin_app_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec);
static void _vala_gedit_find_in_files_plugin_app_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec);
...
static GFile* gedit_find_in_files_plugin_window_get_file_browser_root (GeditFindInFilesPluginWindow* self) {
	...
	GeditMessageBus* _tmp3_ = NULL;
	GeditMessageBus* _tmp4_ = NULL;
	GeditMessageBus* _tmp5_ = NULL;
	GeditMessageBus* _tmp6_ = NULL;
	...
	bus = _tmp5_;
	_tmp6_ = bus;
	_tmp7_ = gedit_message_bus_is_registered (_tmp6_, "/plugins/filebrowser", "get_root");
	if (_tmp7_) {
		GObject* msg = NULL;
		GeditMessageBus* _tmp8_ = NULL;
		GType _tmp9_ = 0UL;
		GObject* _tmp10_ = NULL;
		GObject* _tmp11_ = NULL;
		GeditMessageBus* _tmp12_ = NULL;
		...
		GFile* _tmp17_ = NULL;
		_tmp8_ = bus;
		_tmp9_ = gedit_message_bus_lookup (_tmp8_, "/plugins/filebrowser", "get_root");
		_tmp10_ = g_object_new (_tmp9_, "method", "get_root", "object_path", "/plugins/filebrowser", NULL);
		_tmp11_ = G_IS_INITIALLY_UNOWNED (_tmp10_) ? g_object_ref_sink (_tmp10_) : _tmp10_;
		msg = _tmp11_;
		_tmp12_ = bus;
		_tmp13_ = msg;
		gedit_message_bus_send_message_sync (_tmp12_, G_TYPE_CHECK_INSTANCE_TYPE (_tmp13_, gedit_message_get_type ()) ? ((GeditMessage*) _tmp13_) : NULL);
		g_value_init (&_tmp14_, G_TYPE_OBJECT);
		val = _tmp14_;
		_tmp15_ = msg;
		g_object_get_property (_tmp15_, "location", &val);
		_tmp16_ = g_value_dup_object (&val);
		_tmp17_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp16_, G_TYPE_FILE) ? ((GFile*) _tmp16_) : NULL;
		if (_tmp17_ == NULL) {
...
static void __lambda6_ (Block1Data* _data1_, gint response_id) {
	GeditFindInFilesPluginWindow* self;
	gint _tmp0_ = 0;
	GeditFindInFilesPluginFindDialog* _tmp64_ = NULL;
	GError * _inner_error_ = NULL;
	self = _data1_->self;
	_tmp0_ = response_id;
	if (_tmp0_ == ((gint) GTK_RESPONSE_OK)) {
		gchar* search_text = NULL;
		GeditFindInFilesPluginFindDialog* _tmp1_ = NULL;
		GtkEntry* _tmp2_ = NULL;
		const gchar* _tmp3_ = NULL;
		const gchar* _tmp4_ = NULL;
		gchar* _tmp5_ = NULL;
		gchar* search_path = NULL;
		GeditFindInFilesPluginFindDialog* _tmp6_ = NULL;
		GtkFileChooserButton* _tmp7_ = NULL;
		gchar* _tmp8_ = NULL;
		GtkStack* panel = NULL;
		GeditWindow* _tmp9_ = NULL;
		GeditWindow* _tmp10_ = NULL;
		GeditWindow* _tmp11_ = NULL;
		...
		GeditFindInFilesPluginFindJob* _tmp22_ = NULL;
		GeditFindInFilesPluginFindJob* _tmp23_ = NULL;
		GeditFindInFilesPluginFindDialog* _tmp24_ = NULL;
		GtkCheckButton* _tmp25_ = NULL;
		gboolean _tmp26_ = FALSE;
		gboolean _tmp27_ = FALSE;
		GeditFindInFilesPluginFindJob* _tmp28_ = NULL;
		GeditFindInFilesPluginFindDialog* _tmp29_ = NULL;
		GtkCheckButton* _tmp30_ = NULL;
		gboolean _tmp31_ = FALSE;
		gboolean _tmp32_ = FALSE;
		GeditFindInFilesPluginResultPanel* result_panel = NULL;
		GeditFindInFilesPluginFindJob* _tmp47_ = NULL;
		const gchar* _tmp48_ = NULL;
		GeditWindow* _tmp49_ = NULL;
		GeditWindow* _tmp50_ = NULL;
		GeditWindow* _tmp51_ = NULL;
		GeditFindInFilesPluginResultPanel* _tmp52_ = NULL;
		GeditFindInFilesPluginResultPanel* _tmp53_ = NULL;
		GtkStack* _tmp54_ = NULL;
		GeditFindInFilesPluginResultPanel* _tmp55_ = NULL;
		const gchar* _tmp56_ = NULL;
		gchar* _tmp57_ = NULL;
		gchar* _tmp58_ = NULL;
		GeditFindInFilesPluginResultPanel* _tmp59_ = NULL;
		GtkStack* _tmp60_ = NULL;
		GtkStack* _tmp61_ = NULL;
		GeditFindInFilesPluginResultPanel* _tmp62_ = NULL;
		GeditFindInFilesPluginResultPanel* _tmp63_ = NULL;
		...
		_tmp7_ = _tmp6_->sel_folder;
		_tmp8_ = gtk_file_chooser_get_filename ((GtkFileChooser*) _tmp7_);
		search_path = _tmp8_;
		g_object_get ((GeditWindowActivatable*) self, "window", &_tmp9_, NULL);
		_tmp10_ = _tmp9_;
		_tmp11_ = _tmp10_;
		_tmp12_ = gedit_window_get_bottom_panel (_tmp11_);
		_tmp13_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp12_, gtk_stack_get_type (), GtkStack));
		_tmp14_ = _tmp13_;
		_g_object_unref0 (_tmp11_);
		panel = _tmp14_;
		_tmp15_ = panel;
		_tmp16_ = gtk_stack_get_child_by_name (_tmp15_, "find-in-files");
		...
		_tmp20_ = g_cancellable_new ();
		cancellable = _tmp20_;
		_tmp21_ = cancellable;
		_tmp22_ = gedit_find_in_files_plugin_find_job_new (_tmp21_);
		job = _tmp22_;
		_tmp23_ = job;
		_tmp24_ = _data1_->dialog;
		_tmp25_ = _tmp24_->match_case_checkbutton;
		_tmp26_ = gtk_toggle_button_get_active ((GtkToggleButton*) _tmp25_);
		_tmp27_ = _tmp26_;
		_tmp23_->ignore_case = !_tmp27_;
		_tmp28_ = job;
		_tmp29_ = _data1_->dialog;
		_tmp30_ = _tmp29_->entire_word_checkbutton;
		_tmp31_ = gtk_toggle_button_get_active ((GtkToggleButton*) _tmp30_);
		_tmp32_ = _tmp31_;
		_tmp28_->match_whole_word = _tmp32_;
		{
			GeditFindInFilesPluginFindJob* _tmp33_ = NULL;
			GeditFindInFilesPluginFindDialog* _tmp34_ = NULL;
			GtkEntry* _tmp35_ = NULL;
			const gchar* _tmp36_ = NULL;
			const gchar* _tmp37_ = NULL;
			GeditFindInFilesPluginFindDialog* _tmp38_ = NULL;
			GtkCheckButton* _tmp39_ = NULL;
			gboolean _tmp40_ = FALSE;
			gboolean _tmp41_ = FALSE;
			GeditFindInFilesPluginFindJob* _tmp42_ = NULL;
			const gchar* _tmp43_ = NULL;
			_tmp33_ = job;
			_tmp34_ = _data1_->dialog;
			_tmp35_ = _tmp34_->search_entry;
			_tmp36_ = gtk_entry_get_text (_tmp35_);
			_tmp37_ = _tmp36_;
			_tmp38_ = _data1_->dialog;
			_tmp39_ = _tmp38_->regex_checkbutton;
			_tmp40_ = gtk_toggle_button_get_active ((GtkToggleButton*) _tmp39_);
			_tmp41_ = _tmp40_;
			gedit_find_in_files_plugin_find_job_prepare (_tmp33_, _tmp37_, _tmp41_, &_inner_error_);
			if (G_UNLIKELY (_inner_error_ != NULL)) {
				goto __catch4_g_error;
			}
			_tmp42_ = job;
			_tmp43_ = search_path;
			gedit_find_in_files_plugin_find_job_execute (_tmp42_, _tmp43_, NULL, NULL);
		}
		goto __finally4;
		__catch4_g_error:
		{
			...
			GeditFindInFilesPluginFindDialog* _tmp46_ = NULL;
			err = _inner_error_;
			_inner_error_ = NULL;
			_tmp44_ = err;
			_tmp45_ = _tmp44_->message;
			g_warning ("plugin.vala:104: %s", _tmp45_);
		...
		_tmp47_ = job;
		_tmp48_ = search_path;
		g_object_get ((GeditWindowActivatable*) self, "window", &_tmp49_, NULL);
		_tmp50_ = _tmp49_;
		_tmp51_ = _tmp50_;
		_tmp52_ = gedit_find_in_files_plugin_result_panel_new_for_job (_tmp47_, _tmp48_, _tmp51_);
		g_object_ref_sink (_tmp52_);
		_tmp53_ = _tmp52_;
		_g_object_unref0 (_tmp51_);
		result_panel = _tmp53_;
		_tmp54_ = panel;
		_tmp55_ = result_panel;
		_tmp56_ = search_text;
		_tmp57_ = g_strdup_printf ("\"%s\"", _tmp56_);
		_tmp58_ = _tmp57_;
		gtk_stack_add_titled (_tmp54_, (GtkWidget*) _tmp55_, "find-in-files", _tmp58_);
		_g_free0 (_tmp58_);
		_tmp59_ = result_panel;
		gtk_widget_show_all ((GtkWidget*) _tmp59_);
		_tmp60_ = panel;
		gtk_widget_set_visible ((GtkWidget*) _tmp60_, TRUE);
		_tmp61_ = panel;
		gtk_stack_set_visible_child_name (_tmp61_, "find-in-files");
		_tmp62_ = result_panel;
		gedit_find_in_files_plugin_result_panel_toggle_stop_button (_tmp62_, TRUE);
		_tmp63_ = result_panel;
		gedit_find_in_files_plugin_result_panel_grab_focus (_tmp63_);
	...
	_tmp64_ = _data1_->dialog;
	gtk_widget_destroy ((GtkWidget*) _tmp64_);
}
...
static void gedit_find_in_files_plugin_window_dialog_run (GeditFindInFilesPluginWindow* self) {
	...
	GFile* _tmp15_ = NULL;
	GFile* _tmp18_ = NULL;
	GeditFindInFilesPluginFindDialog* _tmp19_ = NULL;
	GeditFindInFilesPluginFindDialog* _tmp20_ = NULL;
	GeditWindow* _tmp21_ = NULL;
	GeditWindow* _tmp22_ = NULL;
	GeditWindow* _tmp23_ = NULL;
	GeditFindInFilesPluginFindDialog* _tmp24_ = NULL;
	GtkTextIter start = {0};
	GtkTextIter end = {0};
	GeditDocument* _tmp25_ = NULL;
	GtkTextIter _tmp26_ = {0};
	GtkTextIter _tmp27_ = {0};
	gboolean _tmp28_ = FALSE;
	GeditFindInFilesPluginFindDialog* _tmp38_ = NULL;
	GeditFindInFilesPluginFindDialog* _tmp39_ = NULL;
	...
	if (_tmp28_) {
		...
		GeditDocument* _tmp29_ = NULL;
		GtkTextIter _tmp30_ = {0};
		GtkTextIter _tmp31_ = {0};
		gchar* _tmp32_ = NULL;
		GeditFindInFilesPluginFindDialog* _tmp33_ = NULL;
...
static GeditWindow* gedit_find_in_files_plugin_window_real_get_window (GeditWindowActivatable* base) {
	GeditWindow* result;
	GeditFindInFilesPluginWindow* self;
	GeditWindow* _tmp0_ = NULL;
	GeditWindow* _tmp1_ = NULL;
...
static void gedit_find_in_files_plugin_window_real_set_window (GeditWindowActivatable* base, GeditWindow* value) {
	GeditFindInFilesPluginWindow* self;
	GeditWindow* _tmp0_ = NULL;
	GeditWindow* _tmp1_ = NULL;
	self = (GeditFindInFilesPluginWindow*) base;
...
static void gedit_find_in_files_plugin_window_class_init (GeditFindInFilesPluginWindowClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEDIT_FIND_IN_FILES_PLUGIN_WINDOW_WINDOW, g_param_spec_object ("window", "window", "window", gedit_window_get_type (), G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));
}


static void gedit_find_in_files_plugin_window_gedit_window_activatable_interface_init (GeditWindowActivatableInterface * iface) {
...
static void gedit_find_in_files_plugin_window_instance_init (GeditFindInFilesPluginWindow * self) {
...
GType gedit_find_in_files_plugin_window_get_type (void) {
...
static void _vala_gedit_find_in_files_plugin_window_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		case GEDIT_FIND_IN_FILES_PLUGIN_WINDOW_WINDOW:
...
static void gedit_find_in_files_plugin_app_real_activate (GeditAppActivatable* base) {
	...
	GeditMenuExtension* _tmp0_ = NULL;
	GMenuItem* item = NULL;
	const gchar* _tmp1_ = NULL;
	GMenuItem* _tmp2_ = NULL;
	GeditMenuExtension* _tmp3_ = NULL;
	static const gchar* accels[] = {"<Shift><Ctrl>f"};
	GeditApp* _tmp4_ = NULL;
	GeditApp* _tmp5_ = NULL;
	GeditApp* _tmp6_ = NULL;
	...
	_tmp1_ = _ ("Find in Files…");
	_tmp2_ = g_menu_item_new (_tmp1_, "win.find-in-files");
	item = _tmp2_;
	_tmp3_ = self->priv->menu_ext;
	gedit_menu_extension_append_menu_item (_tmp3_, item);
	g_object_get ((GeditAppActivatable*) self, "app", &_tmp4_, NULL);
	_tmp5_ = _tmp4_;
	_tmp6_ = _tmp5_;
	gtk_application_set_accels_for_action ((GtkApplication*) _tmp6_, "win.find-in-files", accels);
...
static void gedit_find_in_files_plugin_app_real_deactivate (GeditAppActivatable* base) {
	GeditFindInFilesPluginApp * self;
	GeditMenuExtension* _tmp0_ = NULL;
	static const gchar* accels[] = {};
	GeditApp* _tmp1_ = NULL;
	GeditApp* _tmp2_ = NULL;
	GeditApp* _tmp3_ = NULL;
	self = (GeditFindInFilesPluginApp*) base;
...
static GeditApp* gedit_find_in_files_plugin_app_real_get_app (GeditAppActivatable* base) {
	GeditApp* result;
	GeditFindInFilesPluginApp* self;
...
static void gedit_find_in_files_plugin_app_real_set_app (GeditAppActivatable* base, GeditApp* value) {
	GeditFindInFilesPluginApp* self;
	GeditApp* _tmp0_ = NULL;
	GeditApp* _tmp1_ = NULL;
	self = (GeditFindInFilesPluginApp*) base;
...
static void gedit_find_in_files_plugin_app_class_init (GeditFindInFilesPluginAppClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), GEDIT_FIND_IN_FILES_PLUGIN_APP_APP, g_param_spec_object ("app", "app", "app", gedit_app_get_type (), G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));
}


static void gedit_find_in_files_plugin_app_gedit_app_activatable_interface_init (GeditAppActivatableInterface * iface) {
...
static void gedit_find_in_files_plugin_app_instance_init (GeditFindInFilesPluginApp * self) {
...
GType gedit_find_in_files_plugin_app_get_type (void) {
...
static void _vala_gedit_find_in_files_plugin_app_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		case GEDIT_FIND_IN_FILES_PLUGIN_APP_APP:
